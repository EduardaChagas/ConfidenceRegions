...
In order to improve this issue, we have introduced several changes.

We propose a new title:
\begin{quote}
...
In order to facilitate the revision, we have included at the end of this letter a version in which additions to the previous round are blue, and deletions in red.
