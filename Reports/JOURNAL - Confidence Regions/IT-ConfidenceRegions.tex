...
\author[1\authfn{1}]{Eduarda T.\ C.\ Chagas}
\author[2\authfn{2}]{Marcelo Queiroz}
\author[3\authfn{3}]{Osvaldo A.\ Rosso}
\author[1\authfn{1}]{Heitor S.\ Ramos}
\author[2\authfn{2}]{Christopher G.\ S. Freitas}
\author[2\authfn{2}]{Leonardo V.\ Pereira}
\author[4\authfn{4}]{Alejandro C.\ Frery}
...
\affil[3]{Instituto de F\'isica, Universidade Federal de Alagoas, Brazil}
\affil[4]{School of Mathematics and Statistics, Victoria University of Wellington, New Zealand}
...
\runningauthor{Eduarda T.\ C.\ Chagas}
...
\keywords{Random number generators, Bandt–Pompe approach, Entropy-complexity plane, Information Theory}
\end{abstract}
% \end{frontmatter}
