...
\title{White Noise Test from Ordinal Patterns in the Entropy-Complexity Plane}
...
\fundinginfo{CNPq, Fapeal, and FAPESP (São Paulo Research Foundation) grant 2020/05121-4.}
...
Information Theory descriptors from the histogram of ordinal patterns. 
...
\keywords{Random number generators, Bandt–Pompe approach, Entropy-complexity plane, Ordinal Patterns, Time Series, Information Theory}
\end{abstract}
