...
plot.HC.PCA.trozos <- function(N, dim, lengend ,x.lim = NULL, y.lim = NULL){
  ...
  ggplot(data = PCA.HC.D, aes(x = PC1, y = PC2)) +
    geom_point(size = 2.8, alpha = .4, color = "#757171") +
    geom_point(data = median, aes(x = PC1, y = PC2), colour = "red", size = 9) +
...
#ggsave(p1, filename = "../Reports/JOURNAL - Confidence Regions/Figures/HC-PCA-Trozos-D3N1000.pdf", width = 14, height = 10)
...
ggsave(p3, filename = "../Reports/JOURNAL - Confidence Regions/Figures/HC-PCA-Trozos-D3N50k.pdf", width = 14, height = 10)
...
# print(p4)
# dev.off() 
ggsave(p4, filename = "../Reports/JOURNAL - Confidence Regions/Figures/HC-PCA-Trozos-D6N50k.pdf", width = 14, height = 10)
