...
1. Read the numbers, and for each number:
2. For each value of $D\in\{3,4,5,6\}$ (or embedding dimensions employed in the literature)
3. Compute the number of tied sequences
4. Return binary vectors with the position of the tied sequences
